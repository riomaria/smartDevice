...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var inputModal = document.querySelector('.modal__form input');
  var popupButton = document.querySelector('.aside-info a');
  ...
  var submitForm = document.querySelector('.feedback__form');
  var userName = submitForm.querySelector('#user-name');
  var userPhone = submitForm.querySelector('#user-phone');
  var userQuestion = submitForm.querySelector('#user-question');
  ...
  var itemAccordion = document.querySelectorAll('.accordion__item'); // const mediaMobile = 767;
...
var Modals = /*#__PURE__*/function () {
  function Modals() {
    ...
    this._stopPlay = this._settings[this._settingKey].stopPlay; // this._lockFocus = this._settings[this._settingKey].lockFocus;
