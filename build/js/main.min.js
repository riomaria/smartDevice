...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var validatePhone = function validatePhone(element) {
    element.setCustomValidity('');
    element.checkValidity();
  };

  var messageValidate = function messageValidate(element) {
    if (element.value === '') {
  ...
  var asideButton = document.querySelector('.aside-info a');
  asideButton.href = '#'; // ---------------------------------
  // Submit default

  var feedbackSubmit = document.querySelector('.feedback__form');
  var modalSubmit = document.querySelector('.modal__form');
  var feedbackUserName = '#user-name';
  var feedbackUserPhone = '#user-phone';
  var popupUserName = '#userName';
  var popupUserPhone = '#userPhone';

  var setStorage = function setStorage(element, name, tel) {
    var userName = element.querySelector(name);
    var userPhone = element.querySelector(tel);
    var userQuestion = element.querySelector('textarea');
  ...
  modalSubmit.addEventListener('submit', function (evt) {
    evt.preventDefault();
    setStorage(modalSubmit, popupUserName, popupUserPhone);
  }); // Smooth navigation

  var anchorMenu = document.querySelector('.hero a[href^="#"]');
  var inputFeedback = document.querySelector('.feedback__form input');
  anchorMenu.addEventListener('click', function (evt) {
    evt.preventDefault();
    var blockId = anchorMenu.getAttribute('href');
  ...
  var initHeroButton = function initHeroButton() {
    var mediaMobile = 767;
    var btnHero = document.querySelector('.hero a');
  ...
  var initFeature = function initFeature() {
    var mediaMobile = 767;
    var mediaTablet = 1023;
    var featureCards = document.querySelectorAll('.features li');
    featureCards.forEach(function (item) {
      var titleCard = item.querySelector('h3');
      var textCard = item.querySelector('p');
      var lengthText = textCard.textContent.length;
      var styleItem = getComputedStyle(titleCard);
      var getHeightTitle = parseInt(styleItem.height, 10) / parseInt(styleItem.fontSize, 10);
  ...
  var itemCompany = document.querySelector('.company__inner');
  var buttonCompany = itemCompany.querySelector('.company button');
  ...
  var initCatalogTitle = function initCatalogTitle() {
    var mediaMobile = 767;
    var titleItem = document.querySelector('.catalog h2');

    if (document.body.offsetWidth > mediaMobile) {
      titleItem.textContent = "Smart Device \u043F\u0440\u0435\u0434\u043B\u0430\u0433\u0430\u0435\u0442 \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0435 \u0442\u043E\u0432\u0430\u0440\u044B \u0438\xA0\u0443\u0441\u043B\u0443\u0433\u0438";
    }

    if (document.body.offsetWidth <= mediaMobile) {
      titleItem.textContent = "\u0422\u043E\u0432\u0430\u0440\u044B \u0438\xA0\u0443\u0441\u043B\u0443\u0433\u0438 Smart\xA0Device";
    }
  };
  ...
  var itemAccordion = document.querySelectorAll('.accordion__item');

  var removeState = function removeState() {
    itemAccordion.forEach(function (item) {
      var toggle = item.querySelector('.accordion__toggle');
